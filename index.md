...
replacements for purrr functions such as
[`map()`](https://purrr.tidyverse.org/reference/map.html) and
[`map2_dbl()`](https://purrr.tidyverse.org/reference/map2.html), which
can be replaced with their furrr equivalents of
[`future_map()`](https://furrr.futureverse.org/reference/future_map.md)
and
[`future_map2_dbl()`](https://furrr.futureverse.org/reference/future_map2.md)
to map in parallel.
...
[`map_dbl()`](https://purrr.tidyverse.org/reference/map.html) through
[`future_map_dbl()`](https://furrr.futureverse.org/reference/future_map.md)
and predicate variants like
[`map_at()`](https://purrr.tidyverse.org/reference/map_if.html) through
[`future_map_at()`](https://furrr.futureverse.org/reference/future_map_if.md).
